...
IMG_SIZE = 28
BATCH_SIZE = 256            # Increased batch size for stabler gradients
EPOCHS = 60                 # Slightly higher max epochs with early stopping
...
# ---------------------- Data Augmentation ----------------------
# Light affine transformations improve sketch invariance
...
class QuickDrawCNN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.classifier = nn.Sequential(
            nn.Dropout(0.4),              # Reduced, centralized dropout
...
# ---------------------- Loss & Optimization ----------------------
criterion = nn.CrossEntropyLoss(label_smoothing=0.1)  # Handles sketch ambiguity
optimizer = optim.AdamW(model.parameters(), lr=LR, weight_decay=1e-4)

# Cosine scheduler provides smoother LR decay than ReduceLROnPlateau
