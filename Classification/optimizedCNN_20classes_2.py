# Optimized custom CNN or 20 classes of QuickDraw dataset, adjusted from original optimizedCNN_20classes.py to run faster. Code created with the help of GPT 5.2.
...
for epoch in range(EPOCHS):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), os.path.join(MODELS_DIR, "optimizedCNN_20classes_2.pth"))
        early_stop_counter = 0
    else:
...
# ---------------------- Test Evaluation ----------------------
model.load_state_dict(torch.load(os.path.join(MODELS_DIR, "optimizedCNN_20classes_2.pth")))
model.eval()
