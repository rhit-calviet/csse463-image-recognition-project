...
CLASSES = [
    ...
    "bicycle", "cake", "fish", "guitar", "house", 
    "moon", "mug", "octopus", "pencil", "fork"
]
...
model_path = os.path.join(MODELS_DIR, "simpleCNN_30classes.pth")
torch.save(model.state_dict(), model_path)
print(f"Model saved to {model_path}")

#Test Evaluation
model.load_state_dict(torch.load(os.path.join(MODELS_DIR, "simpleCNN_30classes.pth")))
model.eval()
correct, total = 0, 0
...
plt.tight_layout()
plt.savefig(os.path.join(MODELS_DIR, "loss_acc_curves_30classes.png"))
plt.close()
