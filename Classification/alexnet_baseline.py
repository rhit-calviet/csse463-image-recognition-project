...
class QuickDrawDataset(Dataset):
    def __init__(self, data_dir, classes, samples_per_class):
        ...
        for label, cname in enumerate(tqdm(classes)):
            ...
            for img in data:
                # Resize to AlexNet standard input size --- this may be the big issue since the image becomes super blurry
...
class ModifiedAlexNet(nn.Module):
    ...
    def unfreeze_last(self):
        # enable gradients for the last few layers of the backbone
